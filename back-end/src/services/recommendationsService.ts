...
async function getRandom() {
  ...
  const scoreFilter =
    recommendationsService.recommendationService.getScoreFilter(random);

  const recommendations = await recommendationsService.recommendationService.getByScore(scoreFilter);
